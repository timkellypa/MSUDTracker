...
define(function (require) {
    ...
    var
        ...
        IDataCollectionTest = require("../../../Core/Test/Data/IDataCollectionTest.base"),
        DateHelpers = require("../../../Core/Lib/DateHelpers"),
        db,
                ...
                it("Finds a food diary entry that occurred on a particular day", function (done) {
                    ...
                    db.init().then(
                        function () {
                            ...
                            dayConsumed = DateHelpers.getEpochDayFromTime(curFoodDiaryEntry.eatenTime);
                                ...
                                function (vals) {
                                    ...
                                    if (match === null) {
                                        ...
                                        assert.deepEqual(match.getPropertyObject(), curFoodDiaryEntry,
                                            "match should the object in the initial data array.");
                                    }
                                    done();
                                },
                                function (e) {
