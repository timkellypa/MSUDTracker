 ...
 * @memberof Test.Core
 */
export default class IDataObjectTest {
    /**
     * Execute tests
     * @param {function(new:IDataObject)} Obj inherited class, on which to run tests on core
     * @param {Object} initialData data for our object.
     * @param {Object} [foreignKeyInfo] all info needed for an "include" test (foreign key).
     * @param {IDataCollection} foreignKeyInfo.collection IDatacollection for the foreignKeyInfo object
