...
export default class DayPicker {
     ...
     * @param {ObservableVar} valueVar value variable
     * @param {ObservableVar} minValueVar min value variable
     * @param {ObservableVar} maxValueVar max value variable
     */
    constructor(valueVar, minValueVar, maxValueVar) {
        /**
