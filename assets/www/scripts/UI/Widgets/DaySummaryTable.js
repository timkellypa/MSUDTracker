...
define(function(require) {
     ...
     * @param {window.ViewModel.Classes.FoodDiaryDaySummary}
     *            foodDiaryDaySummary food diary summary of the day. Contains
     *            all properties needed for this table.
     */
    ...
    /** @lends window.UI.Widgets.DaySummaryTable.prototype */
    {
        ...
        show: function(screen, template, headerExt) {
            var me = this, newElement = $("<div></div>")[0], summaries;
            ...
            // the container.
            summaries = $(screen).find(".DaySummaryTable");
